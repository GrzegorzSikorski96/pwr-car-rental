    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('rented', 'Rented'), ('need service', 'Need service'), ('in service', 'In service'), ('ready to rent', 'Ready to rent')], default='ready to rent', max_length=15)),
